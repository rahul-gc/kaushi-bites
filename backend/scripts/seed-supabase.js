...
const seedDatabase = async () => {
  try {
    ...
    await supabase.from('orders').delete().neq('id', 'impossible');
    await supabase.from('users').delete().neq('id', 'impossible');
    await supabase.from('menu_items').delete().neq('id', 'impossible');
    await supabase.from('categories').delete().neq('id', 'impossible');
    ...
    const adminPassword = await bcrypt.hash('kaushi@2025', 12);
    ...
    console.log('✅ Created admin user (admin@kaushi.com / kaushi@2025)');
    ...
    console.log('\n📋 Login credentials:');
    console.log('Admin: admin@kaushi.com / kaushi@2025');
    console.log('Sample Users: ram@email.com / password123, sita@email.com / password123');
